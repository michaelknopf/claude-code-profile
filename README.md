...
- **Output**: `docs/local/refactor-audit-YYYY-MM-DD-HH-MM.md`
...
- **Output**: `docs/local/coverage-audit-YYYY-MM-DD-HH-MM.md`
...
- **Output**: `docs/local/typing-audit-YYYY-MM-DD-HH-MM.md`
...
- **Output**: `docs/local/review-pr-{BRANCH}-YYYY-MM-DD-HH-MM.md`
- **Example**: `/review-pr`
