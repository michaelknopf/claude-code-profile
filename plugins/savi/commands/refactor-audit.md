...
**Default behavior**: Saves report to `docs/notes/reports/refactor-audit-YYYY-MM-DD.md` AND displays in conversation.
...
**Default**: Save report to `docs/notes/reports/refactor-audit-{YYYY-MM-DD}.md` AND display in conversation
...
5. Show confirmation: "📄 Report saved to `docs/notes/reports/refactor-audit-2026-01-11.md`"
...
### Example 1: Full codebase audit (saves to docs/notes/reports/refactor-audit-YYYY-MM-DD.md)
```
/refactor-audit
```
