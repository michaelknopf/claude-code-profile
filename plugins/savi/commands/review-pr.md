...
1. **Determine output path:** `docs/local/reports/review-pr-{BRANCH}-{YYYY-MM-DD-HH-MM}.md`
...
Full report saved to: `docs/local/reports/review-pr-add-auth-2026-01-23-14-30.md`

To implement these findings:
  /savi:epic-loop docs/local/reports/review-pr-add-auth-2026-01-23-14-30.md
```
