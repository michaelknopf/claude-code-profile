...
**Default behavior**: Saves report to `docs/local/reports/typing-audit-YYYY-MM-DD-HH-MM.md` AND displays in conversation.
...
**Default**: Save report to `docs/local/reports/typing-audit-{YYYY-MM-DD-HH-MM}.md` AND display in conversation
...
5. Show confirmation: "Report saved to `docs/local/reports/typing-audit-2026-01-11-14-30.md`. To implement, run: `/savi:epic-loop docs/local/reports/typing-audit-2026-01-11-14-30.md`"
...
### Example 1: Full codebase audit (saves to docs/local/reports/typing-audit-YYYY-MM-DD-HH-MM.md)
```
/typing-audit
```
